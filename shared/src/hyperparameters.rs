...
pub const FIRST_ITERATION_PROBABILITY: f64 = 0.5; // Probability for the first iteration
pub const SECOND_ITERATION_PROBABILITY: f64 = 0.25; //
...
pub const MAX_TRIALS: usize = 2000; // Maximum number of trials to find a trace
